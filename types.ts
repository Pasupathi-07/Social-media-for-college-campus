...
export interface User {
  ...
  year?: string; // Year of study for students
...
export type EventType = 'Academic' | 'Cultural' | 'Sports' | 'Technical' | 'Social' | 'Workshop' | 'Seminar' | 'Competition' | 'Other';
...
export interface Event {
  ...
  time: string;
  venue: string;
  brochureUrl?: string; // Base64 image
